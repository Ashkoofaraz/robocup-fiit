...
\usepackage{amsmath}
\usepackage{amsfonts}
\usepackage[left=3.5cm]{geometry}			% pre rozmery stran a pod.
\usepackage{array}
...
\input{lukas_durcak.tex}

\input{peter_passak.tex}

\input{auder_hudec_passakm_hujsi.tex}

\input{A55Kickers.tex}

\input{older_teams.tex}

\input{foreign_teams.tex}
...
\input{appendix_nao_model.tex}
\newpage
\input{appendix_dh.tex}
\newpage
\input{appendix_medium.tex}
\newpage
\input{appendix_install_guide.tex}
\newpage
\input{appendix_user_guide.tex}
