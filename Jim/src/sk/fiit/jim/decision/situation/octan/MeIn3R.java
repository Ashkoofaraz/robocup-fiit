 ...
 *         Our
 *         
 * @return boolean - Returns true only if i am standing in quadrant R3
 */

public class MeIn3R extends Situation {
	...
	public boolean checkSituation() {
		if ((this.agentModel.getPosition().getX() > MeIn3R.POSITION_MIN_X)
				&& (this.agentModel.getPosition().getX() <= MeIn3R.POSITION_MAX_X)
				&& (this.agentModel.getPosition().getY() < MeIn3R.POSITION_MAX_Y)) {
			return true;
		}
		return false;
	}
