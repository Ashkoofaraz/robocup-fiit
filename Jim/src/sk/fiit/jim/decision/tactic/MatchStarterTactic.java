...
public class MatchStarterTactic
{
    ...
    public void runStart()
    {
        ...
        {
            this.moveExec.move(Vector3D.cartesian(0, 0, 0), MovementSpeedEnum.WALK_MEDIUM);
        }
        this.moveExec.move(Vector3D.cartesian((agentX + INITIAL_DISTANCE), 0, 0), MovementSpeedEnum.WALK_MEDIUM);
    }
    ...
    public void runBeam()
    {
        ...
        case 1:
            this.beamExec.BeamAgent(Vector3D.cartesian(-0.2, -0.055, 0.4));
