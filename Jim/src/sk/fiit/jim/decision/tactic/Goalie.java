...
public class Goalie extends Tactic
{
    ...
    private ArrayList<String> prescribedSituations = new ArrayList<String>(Arrays.asList(MeIn1R.class.getName(),
            MeIn1L.class.getName(), BallOnGoal.class.getName()));

    private ArrayList<String> initSituations = new ArrayList<String>(Arrays.asList(MeIn1L.class.getName(),
            MeIn1R.class.getName()));

    private ArrayList<String> progressSituations = new ArrayList<String>(Arrays.asList(MeIn1L.class.getName(),
            MeIn1R.class.getName()));
     ...
     */
    // Todo #Task() #Solver() #Priority() | xmarkech
    // 2013-12-10T20:38:13.4560000Z
    public void run()
    {
        // Vector3D position_to_go = Vector3D.cartesian(10, 1, 0.4);
        // Planner.getPlan().Highskill_Queue.add(new
        // GoToPosition(position_to_go,
        // new LambdaCallable() {
        // public boolean call() {
