 ...
 * DynamicSkill.java
 * 
 * Base class for new dynamic skills. It is extended from classic HighSkill so
 * dynamic skills can use same mechanism as classic skills. After calculation
 * and creation of phases there is no difference between dynamic and classic
 * skill.
 * 
...
public abstract class DynamicSkill extends HighSkill
{
     ...
     */
    protected LowSkill addSkill(String name)// , List<String> types, String
                                            // extendedFrom)
    {
    ...
    /*
     * Pridava fazy do zoznamu faz. Pridavaju sa v poradi ako su v zozname a
     * mena faz su generovane podla nazvu skillu ku ktoremu patria
     */
    ...
    /*
     * Vytvori novu fazu do ktorej je nasledne mozne pridavat nastavenia
     * efektorov
     */
    ...
    /*
     * Vrati vsetky fazy pre dany LowSkill v poradi. Potrebne pre nacitanie faz
     * ako podkladu pre dynamicky kop.
     */
    ...
    /*
     * Zaokruhluje duration na nasobky 20ms kvoli nastaveniu servera a prevadza
     * potom cele cislo na desatiny vydelenim 1000 Skopirovane z
     * SkillFromXmlLoader.java
     */
