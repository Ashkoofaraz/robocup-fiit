 ...
 * 
 * Class containing 1st dynamic skill extended from DynamicSkill. It is Dynamic
 * straight kick based on kick_right_normal_stand or kick_left_normal_stand Some
 * phases of kick are static and same as in normal kick. Others mainly
 * controlling power of kick are dynamic and their value change based on
 * distance to which should kick reach.
 * 
...
{
    /*
     * Vytvara dynamicky kop Na zaciatku sa vypocitaju parametre kopu a nasledne
     * sa nastavia fazy Kop je zalozeny na kick_right_normal_stand a
     * kick_left_normal_stand ma 6 faz pricom dynamicky sa nastavuju fazy 2-3 Je
     * mozne bud vsetky fazy zadat priamo, alebo je mozne nacitat existujuci kop
     * a nahradit niektore jeho fazy alebo len hodnoty vo fazach
     */
    ...
    /*
     * Vytvara kop Poradie faz je dolezite, budu na seba nadvazovat v poradi ako
     * su pridane do zoznamu
     */
    private void alterKickPhases(List<Phase> phases, String side, double distance)
    {
        // Fazy v zakladnom kope zacinaju s default a fazou0, takze pre X-tu
        // fazu v poradi treba hladat index X+1. Faza default je teda index 0,
        // faza0 je index 1, ...
