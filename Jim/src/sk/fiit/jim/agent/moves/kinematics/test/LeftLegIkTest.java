...
//                                System.out.println(inverseKinResult);
                                ...
                                line.append(";");
                                line.append(String.format(Locale.GERMAN, "%.2f", forwKinResult.getOrientation().getAxRadians()));
                                line.append(";");
                                line.append(String.format(Locale.GERMAN, "%.2f", forwKinResult.getOrientation().getAyRadians()));
                                line.append(";");
                                line.append(String.format(Locale.GERMAN, "%.2f", forwKinResult.getOrientation().getAzRadians()));
                                line.append(";");
                                ...
                                line.append(";");
                                line.append(String.format(Locale.GERMAN, "%.2f", validation.getOrientation().getAxRadians()));
                                line.append(";");
                                line.append(String.format(Locale.GERMAN, "%.2f", validation.getOrientation().getAyRadians()));
                                line.append(";");
                                line.append(String.format(Locale.GERMAN, "%.2f", validation.getOrientation().getAzRadians()));
                                line.append("\n");
