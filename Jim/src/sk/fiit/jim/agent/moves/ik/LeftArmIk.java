...
class LeftArmIk
{
    ...
    double getTheta4()
    {
        ...
        double d = sqrt((sx - T03) * (sx - T03) + (sy - T13)
                * (sy - T13) + (sz - T23) * (sz - T23));
    ...
    double getTheta2()
    {
        ...
        double nominator = T13 - l1
                - ((l4 * sin(theta4) * T11) / (cos(theta4)));
    ...
    double getTheta1()
    {
        if(abs(theta3) != PI / 2)
        {
            ...
            double nominator = T22
                    + ((T02 * sin(-1 * theta3) * cos(theta3 - PI / 2)) / (cos(-1
                            * theta3)));
