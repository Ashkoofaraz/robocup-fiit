 ...
 * </p>
 * <p>
 * Most of the elements are generated automatically by the Jigloo GUI builder in
 * the createGUI() method.
 * </p>
 * <p>
 * Note: Currently, most of the listeners are added manually in the
 * registerGUIListeners() method. This makes the code easier to navigate in my
 * opinion, because they're all in one place. It could be changed to add them
 * automatically in the GUI editor, but the events should not be handled inline
 * (they should still just call a handler method in this class)
 * </p>
 */
        ...
        UserInterface, IAgentMonitorListener, IAgentManagerListener
{
    ...
    public MainFrame(RobocupServerAddress robocupAddress)
    {
        ...
        logger.addHandler(new Handler()
        {
            ...
            {
                txtLogArea.append(rec.getLevel().toString() + ": "
                        + rec.getMessage() + "\n");
        ...
        // zatial len ako demo -> model sa do danej metody receivedMessage este
        // neposle
        AgentMonitor.setMessageListener(1, "ANDROIDS", this,
                AgentMonitorMessage.TYPE_WORLD_MODEL);
    }
    ...
    private void registerGUIListeners()
    {
        ...
        // as necessary
        AgentManager.getManager().addAgentManagerListener(
                new IAgentManagerListener()
                {
                    ...
                    public void agentOutputLine(AgentJim agent, String line)
                    {
                        if(comboAgentOut.getSelectedItem() == agent)
                        {
                            ...
                            txtAgentOut.setCaretPosition(txtAgentOut.getText()
                                    .length() - 1);
                        }
                    }
                });
    ...
    protected void btnApplyGraphicalClicked(ActionEvent evt)
    {
        ...
        else
        {
            ...
            gameView.setWMDrawingAgent((AgentJim) comboWmAgent
                    .getSelectedItem());
        }
    }
    ...
    protected void btnTestCaseClicked(ActionEvent evt)
    {
        ...
        else
        {
            ...
            new Thread(((TestHolder) comboTestCase.getSelectedItem()).runnable)
                    .start();
        }
    }
    ...
    protected void btnAnnotateClicked(ActionEvent evt)
    {
        ...
        new Annotator(loops, circle, txtAnnotMove.getText(), new File(
                txtAnnotDest.getText())).annotate();
    }
    ...
    protected void btnSetAgentPosClicked(ActionEvent evt)
    {
        ...
        try
        {
            trainer.setAgentPosition(aj.getAgentData(),
                    getPoint3D(txtAgentPos.getText()));
        }
        catch (Exception e)
        {
    ...
    /**
     * Creates all the GUI elements. Most of the code in this method is
    ...
    private void createGUI()
    {
        ...
        splitPane.setLeftComponent(tabbedPane);
        {
            ...
            tabServerMonitoring.setLayout(bl_tabServerMonitoring);
            {
                ...
                tabServerMonitoring.add(monitoringPane, BorderLayout.CENTER);
                {
                    ...
                    tabMonitorData.setLayout(bl_tabMonitorData);
                    {
                                ...
                                482, 279));
                        {
                            ...
                            ((DefaultCaret) txtJimInfo.getCaret())
                ...
                }
                {
                    ...
                    monitoringPane.addTab("Graphical view", null, tabGraphical,
                            null);
                    {
                ...
                }
                {
                    ...
                    monitoringPane.addTab("Graphical view settings", null,
                            tabGraphicalSettings, null);
                    ...
                    {
                        ComboBoxModel comboWmDataModel = new DefaultComboBoxModel(
                                new String[] { "All agents", "No agents",
                                        "Selected agent" });
            ...
            }
            {
                ...
                GroupLayout monitoringSidebarLayout = new GroupLayout(
                        (JComponent) monitoringSidebar);
                monitoringSidebar.setLayout(monitoringSidebarLayout);
                tabServerMonitoring.add(monitoringSidebar, BorderLayout.EAST);
                monitoringSidebar.setPreferredSize(new java.awt.Dimension(197,
                        419));
                {
                    ...
                    panelControls.setBorder(BorderFactory
                    ...
                    {
                        ComboBoxModel comboTestCaseModel = new TestCaseComboModel();
                ...
                }
                {
                    ...
                    panelAgent.setBorder(BorderFactory
                            .createTitledBorder("Agent"));
                    {
                ...
                }
                {
                    ...
                    panelBall.setBorder(BorderFactory
                            .createTitledBorder("Ball"));
                    {
                ...
                monitoringSidebarLayout
                        .setHorizontalGroup(monitoringSidebarLayout
                                ...
                                .addContainerGap());
                monitoringSidebarLayout
                        .setVerticalGroup(monitoringSidebarLayout
                                .createSequentialGroup()
                                .addContainerGap()
                                ...
                                .addComponent(panelAgent,
                                        GroupLayout.PREFERRED_SIZE, 120,
                                        GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(
                                        LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(panelBall,
        ...
        }
        {
            ...
            GroupLayout tabManageAgentsLayout = new GroupLayout(
                    (JComponent) tabManageAgents);
            ...
            tabbedPane.addTab("Manage agents", null, tabManageAgents, null);
            {
                ...
                panelAddAgent.setBorder(BorderFactory
                        .createTitledBorder("Add new agent"));
                ...
                {
                    ComboBoxModel comboTeamModel = new DefaultComboBoxModel(
            ...
            }
            {
                ...
                panelAgentOut.setBorder(BorderFactory
                ...
                }
                {
                    ...
                    scrollAgentOut.setPreferredSize(new java.awt.Dimension(667,
                            143));
                    {
                        txtAgentOut = new JTextArea();
                        scrollAgentOut.setViewportView(txtAgentOut);
                        txtAgentOut.setFont(new java.awt.Font("Monospaced", 0,
                                12));
                    }
                }
            }
            {
                ...
                GroupLayout panelAgentControlLayout = new GroupLayout(
                        (JComponent) panelAgentControl);
                panelAgentControl.setLayout(panelAgentControlLayout);
                panelAgentControl.setBorder(BorderFactory
                        .createTitledBorder("Control agent"));
                {
                ...
                panelAgentControlLayout
                        .setHorizontalGroup(panelAgentControlLayout
                                .createSequentialGroup()
                                .addContainerGap()
                                .addGroup(
                                        panelAgentControlLayout
                                ...
                                .addContainerGap());
                panelAgentControlLayout
                        .setVerticalGroup(panelAgentControlLayout
                                .createSequentialGroup()
                                .addContainerGap()
                                .addComponent(comboAgentControl,
                                ...
                                .addPreferredGap(
                                        LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(btnAgentMonitor,
                                        GroupLayout.PREFERRED_SIZE, 25,
                                        GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 8, Short.MAX_VALUE));
            }
            tabManageAgentsLayout
                    .setHorizontalGroup(tabManageAgentsLayout
                            .createSequentialGroup()
                            .addContainerGap()
                            .addGroup(
                                    tabManageAgentsLayout
                            ...
                            .addContainerGap());
            tabManageAgentsLayout
                    .setVerticalGroup(tabManageAgentsLayout
                            .createSequentialGroup()
                            .addContainerGap()
                            .addGroup(
                                    tabManageAgentsLayout
                            ...
                            .addPreferredGap(
                                    LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(panelAgentOut, 0, 217,
    ...
    /**
     * Upon finishing a test case, resets the state and makes it possible to run
     * a new one
     */
    @Override
     ...
     *             if the number of items isn't 3 or if they're not valid
     *             numbers
     */
     ...
     * 
     * @see
     * sk.fiit.testframework.monitor.IAgentMonitorListener#receivedMessage(int,
     * java.lang.String, sk.fiit.testframework.monitor.AgentMonitorMessage)
     * poslany model sveta od hraca (vykonat update UI)
     */
    @Override
    public void receivedMessage(int uniform, String team,
     ...
     * 
     * @see
     * sk.fiit.testframework.communication.agent.IAgentManagerListener#agentAdded
