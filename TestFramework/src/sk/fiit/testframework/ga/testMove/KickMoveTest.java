 ...
 *
 */
public class KickMoveTest extends TestCase {
	private static Logger logger = Logger.getLogger(KickMoveTest.class.getName());
	...
	public KickMoveTest(AgentJim agent,AgentMove move, EnvironmentSetting eS, ParameterGA paramGA, TestTypeParameter paramTT) {
		super();
		this.agent=agent;
